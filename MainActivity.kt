...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jogo = Jogo(1,100)
        this.btchute = findViewById(R.id.buttonSorte)
        this.menor = findViewById(R.id.menorNumero)
        this.maior = findViewById(R.id.maiorNumero)
        this.numero = findViewById(R.id.numero)/*CampoNumero*/
